    ...
    <?php
       ...
       $select=mysqli_query($con,"SELECT* from recruiter");
        ...
        <td><?php echo $row['RecruiterID']?></td>
          ...
          <td>
            <a href="deleterecuiter.php?user_id=<?php echo $row['RecruiterID']?>"><button class="delete">delete</button></a>
            <a href=".php?user_id=<?php echo $row['RecruiterID']?>"><button class="update">update</button></a>
          </td>
